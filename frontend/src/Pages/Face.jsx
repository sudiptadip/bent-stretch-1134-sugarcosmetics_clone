...
function Face() {
  ...
  useEffect(() => {
    let url = "https://concerned-cyan-tank-top.cyclic.app/Face";
    if (prod.length !== 0 && order.length !== 0)
      url = `https://concerned-cyan-tank-top.cyclic.app/Face?_sort=price&_order=${order}&q=${prod}`;
    else if (prod.length !== 0)
      url = `https://concerned-cyan-tank-top.cyclic.app/Face?q=${prod}`;
    else if (order.length !== 0)
      url = `https://concerned-cyan-tank-top.cyclic.app/Face?_sort=price&_order=${order}`;
