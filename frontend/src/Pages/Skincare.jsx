...
function Skincare() {
  ...
  useEffect(() => {
    let url = "https://gearbest-database.onrender.com/skincare";
    if (prod.length !== 0 && order.length !== 0)
      url = `https://gearbest-database.onrender.com/skincare?_sort=price&_order=${order}&q=${prod}`;
    else if (prod.length !== 0)
      url = `https://gearbest-database.onrender.com/skincare?q=${prod}`;
    else if (order.length !== 0)
      url = `https://gearbest-database.onrender.com/skincare?_sort=price&_order=${order}`;
    ...
    <div>
      <Box position="relative">
        <Box filter="blur(20px)" height="272px" width="100%" overflow="hidden">
          {" "}
          <img
            src="https://beautybaskets.in/wp-content/uploads/2022/07/maxresdefault.jpg"
            alt=""
          />
        </Box>
        <Box
        ...
        >
          {" "}
          <img 
            src="https://www.bigbasket.com/media/uploads/groot/images/2132022-34ec2e4b-377647461-banner1-1200x300-2.jpg"
            alt=""
          />
        </Box>
      </Box>
            ...
            <Box>
              <Menu matchWidth="true">
                ...
                <MenuList>
                  ...
                  <MenuItemOption onClick={() => changeUrlType("cleansing-water")}>
                  Cleansing-Water
                  </MenuItemOption>
                  <MenuItemOption onClick={() => changeUrlType("acne-combo")}>
                    Acne-Combo
                  </MenuItemOption>
