...
function Eyes() {
  ...
  useEffect(() => {
    let url = "https://concerned-cyan-tank-top.cyclic.app/Eyes";
    if (prod.length !== 0 && order.length !== 0)
      url = `https://concerned-cyan-tank-top.cyclic.app/Eyes?_sort=price&_order=${order}&q=${prod}`;
    else if (prod.length !== 0)
      url = `https://concerned-cyan-tank-top.cyclic.app/Eyes?q=${prod}`;
    else if (order.length !== 0)
      url = `https://concerned-cyan-tank-top.cyclic.app/Eyes?_sort=price&_order=${order}`;
