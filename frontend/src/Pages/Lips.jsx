...
function Lips() {
  ...
  useEffect(() => {
    let url = "https://concerned-cyan-tank-top.cyclic.app/Lips";
    if (prod.length !== 0 && order.length !== 0)
      url = `https://concerned-cyan-tank-top.cyclic.app/Lips?_sort=price&_order=${order}&q=${prod}`;
    else if (prod.length !== 0)
      url = `https://concerned-cyan-tank-top.cyclic.app/Lips?q=${prod}`;
    else if (order.length !== 0)
      url = `https://concerned-cyan-tank-top.cyclic.app/Lips?_sort=price&_order=${order}`;
        ...
        >
          ...
          <Box>
            <Menu matchWidth="true">
              ...
              <MenuList>
                <MenuItemOption onClick={() => changeUrlType("crayon")}>
                  Lip Crayon
                </MenuItemOption>
                <MenuItemOption onClick={() => changeUrlType("liquid")}>
                  Liquid Lipstick{" "}
                </MenuItemOption>
                <MenuItemOption onClick={() => changeUrlType("gloss")}>
                  Lip Gloss
                </MenuItemOption>
