...
export default function Cart() {
      ...
      <div>
        ...
        >
          <Box m="auto" w="fit-content">
            {" "}
            <img src="https://in.sugarcosmetics.com/Cart_nofound.svg" alt="" />
          </Box>
          <Box>
            <Text>
  ...
  const ship =
    getShipping().shipping > 0 ? `₹${getShipping().shipping}` : "Free";
      ...
      <>
        ...
        <Modal isOpen={isOpen} onClose={onClose}>
          ...
          <ModalContent>
            ...
            <ModalFooter>
              <Button mr={3} bg="black" color="white" onClick={handleClick}>
                Use this address
              </Button>
      ...
      >
        ...
        >
          <Box>
            ...
            >
              <Input
                placeholder="Enter gift code or coupon code"
                type="text"
                size="md"
                w="80%"
                value={coupon}
            ...
            >
              <Flex flexDirection="column" w="100%">
                <Flex justifyContent="space-between">
                  <Text>Sub Total</Text> <Text>₹{getTotal().totalPrice}</Text>
                </Flex>
                <Flex justifyContent="space-between">
                  <Text>Tax</Text> <Text></Text>₹{getTax().tax}
                </Flex>
                {isdiscount ? (
                  <Flex justifyContent="space-between">
                    <Text>Discount</Text>{" "}
          ...
          {!status && (
            <Box
              ...
              p="15px"
            >
              <Text textAlign="left" color="#757575">
              ...
              <Text textAlign="left" color="#757575">
                Phone number : {useraddress.mobile}
              </Text>
            </Box>
          )}
          <Box>{status ? <BasicUsage /> : <ToastExample />}</Box>
        </Flex>
      </Box>
    </div>
  );
