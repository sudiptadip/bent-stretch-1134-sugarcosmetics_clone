...
export default function LipsIndividual() {
  ...
  const getData = async () => {
    try {
      let res = await fetch(`https://gearbest-database.onrender.com/lips/${id}`);
      ...
      <Box w="90%" bg="white" margin="10px auto" borderRadius="10px">
        <Flex>
          ...
          <Flex m="20px" p="10px" flexDirection="column" gap="10px">
            <Box>
              <Text fontSize="20px" w="fit-content">
                {product.name}
              </Text>
            </Box>
            <Box
              ...
              <Box>
                <UnorderedList display="flex" flexDirection="column" gap="10px">
                  <ListItem>
                    <Box w="fit-content">
                      <Text>
                        Get A Matte Attack Transferproof Lipstick - 06 Spring
                        Crimson (Crimson Red)
                      </Text>
                      <Text w="fit-content">
                        And A Flat Glitter Gold Pouch Free On A Minimum Spend Of
                        Rs. 799
                      </Text>{" "}
                    </Box>
                  </ListItem>
                  <ListItem>
                    <Box w="fit-content">
                      Grab A Complimentary Product Worth Rs.2497 On A Spend Of
                      Rs.3399{" "}
                    </Box>{" "}
                  </ListItem>
                </UnorderedList>
